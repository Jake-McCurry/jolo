...
export default function YesRededicated() {
  useEffect(() => {
    if (typeof window !== "undefined" && (window as any).gtag) {
      (window as any).gtag("event", "conversion", {
        ...
        event_label: "yes_rededicated",
      });
    }
    if (typeof window !== "undefined" && (window as any).fbq) {
      (window as any).fbq("track", "Lead", { content_name: "yes_rededicated" });
    }
  }, []);
  ...
  return (
    <>
      <SEO
        title="Welcome Back — Rededicated Your Life to Jesus"
        description="You've rededicated your life to Jesus. Discover the resources God has for you in the JesusOnline App."
      />
      ...
      <div className="min-h-screen bg-[#E8EDEF] pt-20">
        <div className="bg-secondary text-white py-14 px-4">
          <div className="container mx-auto max-w-2xl text-center">
            ...
            >
              You've rededicated your life to Jesus!
            </motion.h1>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              God's arms are always open. Here's everything you need to grow deeper in your renewed relationship with Him.
            </motion.p>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-2xl px-4 py-12 space-y-8">
          ...
          >
            ...
            <p className="text-white/70 mb-6 text-sm leading-relaxed">
              By inviting Jesus back into your life, not only do you have eternal life in Heaven but also spiritual resources for living here on earth now.
            </p>
