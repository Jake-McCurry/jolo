...
import { STORY_URL, BOOK_PDF_URL, BOOK_COVER_URL, APP_FIND_URL } from "@/lib/urls";
...
export function NextStepsPage({ title, description, path, conversionLabel }: NextStepsPageProps) {
  useEffect(() => {
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-xl mx-auto px-4 py-5 space-y-3">
          ...
          <div className="fade-up d-300 bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="px-5 py-4 flex justify-center">
              <a href={APP_FIND_URL} target="_blank" rel="noopener noreferrer"
